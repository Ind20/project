...
class projectCategory(models.Model):
    ...
    Category_Image          = models.ImageField(default='images/category/category.png', upload_to='images/category/', null='true', blank='true')
...
class project(models.Model):
    ...
    Project_Image           = models.ImageField(default='images/project/project.png', upload_to='images/project/', null='true', blank='true')
